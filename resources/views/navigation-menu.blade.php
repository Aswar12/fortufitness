<nav x-data="{ open: false }" class=" bg-opacity-95">
        ...
        <div class="pt-4 pb-1 border-t border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                ...
                <div class="border-t border-gray-700 pt-4 pb-1">
                    <div class="flex items-center px-4">
                        <div class="font-medium text-base text-gray-300">{{ __('Manage Team') }}</div>
                    </div>
                    ...
                    <div class="border-t border-gray-700 pt-4 pb-1">
                        <div class="flex items-center px-4">
                            <div class="font-medium text-base text-gray-300">{{ __('Switch Teams') }}</div>
                        </div>
